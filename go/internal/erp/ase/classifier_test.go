...
func TestBatchToRows_BasicExtraction(t *testing.T) {
	...
	node1 := NewASENode("tenant-1", "realm-1", "dag-1", map[string]any{"raw_description": "Raw Desc 1", "cash_direction": "INFLOW", "raw_amount": "100.00"})
	node1.NodeID = "node-1"
	node2 := NewASENode("tenant-1", "realm-1", "dag-1", map[string]any{"raw_description": "Raw Desc 2", "cash_direction": "OUTFLOW", "raw_amount": "200.00"})
	node2.NodeID = "node-2"
...
func TestBatchCashDirection(t *testing.T) {
	node1 := NewASENode("tenant-1", "realm-1", "dag-1", map[string]any{"raw_description": "Raw Desc 1", "cash_direction": "INFLOW", "raw_amount": "100.00"})
	node1.NodeID = "node-1"
	node2 := NewASENode("tenant-1", "realm-1", "dag-1", map[string]any{"raw_description": "Raw Desc 2", "cash_direction": "INFLOW", "raw_amount": "200.00"})
	node2.NodeID = "node-2"
