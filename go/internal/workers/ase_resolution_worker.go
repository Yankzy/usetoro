...
func (w *ASEResolutionWorker) ToolDescription() string {
	return "Update a transaction that was on hold, marking it as human-approved and ready to resume in the DAG. Call this when you have gathered enough context to confidently resume the transaction."
}
