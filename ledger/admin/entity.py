...
from ledger.admin.chart_of_accounts import ChartOfAccountsInLine
from ledger.io.io_core import get_localtime
from ledger.models import EntityUnitModel
from ledger.models.entity import EntityModel, EntityManagementModel
...
class EntityModelAdmin(ModelAdmin):
    ...
    def add_ledger_link(self, obj):
        add_ledger_url = reverse('admin:ledger_ledgermodel_add')
    ...
    def dashboard_link(self, obj: EntityModel):
        add_ledger_url = reverse(
            viewname='ledger:entity-dashboard',
            kwargs={
                'entity_slug': obj.slug
            })
        return format_html('<a class="viewlink" href="{url}">View</a>',
