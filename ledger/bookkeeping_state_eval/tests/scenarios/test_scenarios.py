...
from bookkeeping_state.domain.commands import CommandBase
...
def test_no_imports_from_reconciliation_eval() -> None:
    ...
    pkg_dir = eval_root if (eval_root.name == "bookkeeping_state_eval" or (eval_root / "domain").exists()) else eval_root / "bookkeeping_state_eval"
