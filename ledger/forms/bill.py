...
from ledger.io.roles import ASSET_CA_CASH, ASSET_CA_PREPAID, LIABILITY_CL_ACC_PAYABLE
from ledger.models import (ItemModel, AccountModel, BillModel, ItemTransactionModel,
...
class BaseBillModelUpdateForm(BillModelCreateForm):
    ...
    class Meta:
        ...
        widgets = {
            'xref': TextInput(attrs={'class': LEDGER_FORM_INPUT_CLASSES,
                                     'placeholder': 'External Reference...'}),
            'timestamp': DateTimeInput(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'amount_due': TextInput(attrs={'class': LEDGER_FORM_INPUT_CLASSES, 'placeholder': '$$$'}),
            'terms': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'bill_status': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'date_paid': DateInput(
                attrs={
                    'class': LEDGER_FORM_INPUT_CLASSES,
            ...
            'progress': TextInput(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'accrue': CheckboxInput(attrs={'type': 'checkbox'}),
            'paid': CheckboxInput(attrs={'type': 'checkbox'}),
            'cash_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES + ' is-danger'}),
            'prepaid_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES + ' is-danger'}),
            'unearned_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES + ' is-danger'}),
    ...
    class Meta:
        ...
        widgets = {
            'item_model': Select(attrs={
                'class': LEDGER_FORM_INPUT_CLASSES + ' is-small',
            }),
