...
from ledger.io.roles import ASSET_CA_CASH, ASSET_CA_RECEIVABLES, LIABILITY_CL_DEFERRED_REVENUE
from ledger.models import (AccountModel, CustomerModel, InvoiceModel, ItemTransactionModel, ItemModel)
...
class InvoiceModelCreateForEstimateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'customer': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            ...
            'cash_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'prepaid_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'unearned_account': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
        }
...
class BaseInvoiceModelUpdateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'invoice_status': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'customer': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'date_paid': DateInput(
                attrs={
                    'class': LEDGER_FORM_INPUT_CLASSES,
