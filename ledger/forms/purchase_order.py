...
from ledger.models import (ItemModel, PurchaseOrderModel, ItemTransactionModel, EntityUnitModel)
...
class BasePurchaseOrderModelUpdateForm(ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'po_status': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
            'vendor': Select(attrs={'class': LEDGER_FORM_INPUT_CLASSES}),
