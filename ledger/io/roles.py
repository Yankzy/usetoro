...
from ledger.exceptions import InvalidRoleError
...
LIABILITY_LTL_OTHER = 'lia_ltl_other'
LIABILITY_LTL_PROVISIONS = 'lia_ltl_provisions'
...
EQUITY_CONVERSION_DIFFERENCES = 'eq_conversion_diff'
