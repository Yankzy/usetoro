...
from ledger.models.items import ItemTransactionModelQuerySet, ItemTransactionModel, ItemModel, ItemModelQuerySet
...
from ledger.settings import (LEDGER_DOCUMENT_NUMBER_PADDING, LEDGER_BILL_NUMBER_PREFIX)
...
class BillModelAbstract(
    ...
    bill_number: str
        ...
        Prefix be customized with LEDGER_BILL_NUMBER_PREFIX setting.
    ...
    vendor = models.ForeignKey('ledger.VendorModel',
    ...
    bill_items = models.ManyToManyField('ledger.ItemModel',
    ...
    def get_mark_as_draft_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        if not entity_slug:
            entity_slug = self.ledger.entity.slug
        return reverse('ledger:bill-action-mark-as-draft',
                       kwargs={
    ...
    def get_mark_as_review_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        if not entity_slug:
            entity_slug = self.ledger.entity.slug
        return reverse('ledger:bill-action-mark-as-review',
                       kwargs={
                           'entity_slug': entity_slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_approved_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        if not entity_slug:
            entity_slug = self.ledger.entity.slug
        return reverse('ledger:bill-action-mark-as-approved',
                       kwargs={
                           'entity_slug': entity_slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_paid_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        if not entity_slug:
            entity_slug = self.ledger.entity.slug
        return reverse('ledger:bill-action-mark-as-paid',
                       kwargs={
                           'entity_slug': entity_slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_void_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        if not entity_slug:
            entity_slug = self.ledger.entity.slug
        return reverse('ledger:bill-action-mark-as-void',
                       kwargs={
                           'entity_slug': entity_slug,
                           'bill_pk': self.uuid
                       })
    ...
    def get_mark_as_canceled_url(self, entity_slug: Optional[str] = None) -> str:
        ...
        return reverse('ledger:bill-action-mark-as-canceled',
                       kwargs={
                           'entity_slug': entity_slug,
                           'bill_pk': self.uuid
                       })
    ...
    #     if not entity_slug:
    #         entity_slug = self.ledger.entity.slug
    #     return reverse('ledger:bill-action-mark-as-delete',
    #                    kwargs={
    #                        'entity_slug': entity_slug,
    #                        'bill_pk': self.uuid
    #                    })
    ...
    def generate_bill_number(self, commit: bool = False) -> str:
        ...
        if self.can_generate_bill_number():
            with transaction.atomic(durable=True):
                ...
                self.bill_number = f'{LEDGER_BILL_NUMBER_PREFIX}-{state_model.fiscal_year}-{seq}'
    ...
    def get_absolute_url(self):
        return reverse('ledger:bill-detail',
                       kwargs={
                           'entity_slug': self.ledger.entity.slug,
                           'bill_pk': self.uuid
                       })
