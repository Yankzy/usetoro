...
A Chart of Accounts (CoA) is a fundamental component of financial management in Ledger. It serves as the
...
- Co-mingling between different CoAs is not allowed to maintain the integrity of Journal Entries.

This structure ensures a clear and organized approach to financial management within Ledger, facilitating
...
from ledger.io import (ROOT_COA, ROOT_GROUP_LEVEL_2, ROOT_GROUP_META, ROOT_ASSETS,
                              ROOT_LIABILITIES, ROOT_CAPITAL,
                              ROOT_INCOME, ROOT_COGS, ROOT_EXPENSES)
from ledger.models import lazy_loader
from ledger.models.accounts import AccountModel, AccountModelQuerySet
from ledger.models.mixins import CreateUpdateMixIn, SlugNameMixIn
...
class ChartOfAccountModelAbstract(SlugNameMixIn, CreateUpdateMixIn):
    ...
    def insert_account(self,
        ...
        # adds the account model as a child to the 2nd layer root node as 3rd layer account
    ...
    def create_account(self,
        ...
        account_model: AccountModel = self.insert_account(
            account_model=account_model,
            root_account_qs=root_account_qs
        )
        from ledger.tasks import insert_account_embedding_task
    ...
    def mark_as_default_url(self) -> str:
        ...
        """
        return reverse(
            viewname='ledger:coa-action-mark-as-default',
            kwargs={
    ...
    def mark_as_active_url(self) -> str:
        ...
        """
        return reverse(
            viewname='ledger:coa-action-mark-as-active',
            kwargs={
                'entity_slug': self.entity_slug,
                'coa_slug': self.slug
            }
    ...
    def mark_as_inactive_url(self) -> str:
        ...
        """
        return reverse(
            viewname='ledger:coa-action-mark-as-inactive',
            kwargs={
                'entity_slug': self.entity_slug,
                'coa_slug': self.slug
            }
    ...
    def get_create_coa_account_url(self):
        return reverse(
            viewname='ledger:account-create',
            kwargs={
                'coa_slug': self.slug,
                'entity_slug': self.entity_slug
            }
