...
from ledger.models.mixins import ContactInfoMixIn, CreateUpdateMixIn, TaxCollectionMixIn
from ledger.models.utils import lazy_loader
from ledger.settings import LEDGER_DOCUMENT_NUMBER_PADDING, LEDGER_CUSTOMER_NUMBER_PREFIX
...
class CustomerModelAbstract(ContactInfoMixIn, TaxCollectionMixIn, CreateUpdateMixIn):
    ...
    def generate_customer_number(self, commit: bool = False) -> Optional[str]:
        ...
        if self.can_generate_customer_number():
            ...
            self.customer_number = f'{LEDGER_CUSTOMER_NUMBER_PREFIX}-{seq}'
