...
This module provides core functionality for handling data import jobs and staged transactions in the `Ledger`
...
from ledger.io import ASSET_CA_CASH, CREDIT, DEBIT
...
class ImportJobModelAbstract(CreateUpdateMixIn):
    ...
    bank_account_model = models.ForeignKey('ledger.BankAccountModel',
                                           on_delete=models.CASCADE,
                                           verbose_name=_('Associated Bank Account Model'))
    ledger_model = models.OneToOneField('ledger.LedgerModel',
                                        editable=False,
                                        on_delete=models.CASCADE,
...
class StagedTransactionModelAbstract(CreateUpdateMixIn):
    ...
    import_job = models.ForeignKey('ledger.ImportJobModel', on_delete=models.CASCADE)
    ...
    transaction_model = models.OneToOneField('ledger.TransactionModel',
