...
from ledger.models import BillModelQuerySet, InvoiceModelQuerySet
from ledger.models.customer import CustomerModel
from ledger.models.entity import EntityModel, EntityStateModel
from ledger.models.items import ItemTransactionModelQuerySet, ItemTransactionModel, ItemModelQuerySet, ItemModel
from ledger.models.mixins import CreateUpdateMixIn, MarkdownNotesMixIn, ItemizeMixIn
from ledger.models.purchase_order import PurchaseOrderModelQuerySet
...
from ledger.settings import LEDGER_DOCUMENT_NUMBER_PADDING, LEDGER_ESTIMATE_NUMBER_PREFIX
...
class EstimateModelAbstract(CreateUpdateMixIn,
    ...
    The EstimateModel inherits functionality from the following MixIns:
        ...
        1. :func:`MarkdownNotesMixIn <ledger.models.mixins.MarkdownNotesMixIn>`
    ...
    estimate_number: str
        ...
        Prefix be customized with LEDGER_ESTIMATE_NUMBER_PREFIX setting.
    ...
    customer = models.ForeignKey('ledger.CustomerModel', on_delete=models.RESTRICT, verbose_name=_('Customer'))
    ...
    def get_mark_as_draft_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-draft',
                       kwargs={
    ...
    def get_mark_as_review_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-review',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_approved_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-approved',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_completed_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-completed',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_canceled_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-canceled',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def get_mark_as_void_url(self):
        ...
        str
            URL as a String
        """
        return reverse('ledger:customer-estimate-action-mark-as-void',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'ce_pk': self.uuid
                       })
    ...
    def generate_estimate_number(self, commit: bool = False) -> str:
        ...
        if self.can_generate_estimate_number():
            with transaction.atomic(durable=True):
                ...
                self.estimate_number = f'{LEDGER_ESTIMATE_NUMBER_PREFIX}-{state_model.fiscal_year}-{seq}'
