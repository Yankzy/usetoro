...
from ledger.models.accounts import CREDIT, DEBIT
from ledger.models.entity import EntityStateModel, EntityModel
...
from ledger.models.transactions import TransactionModelQuerySet, TransactionModel
from ledger.settings import (
    LEDGER_JE_NUMBER_PREFIX,
    LEDGER_DOCUMENT_NUMBER_PADDING,
    LEDGER_JE_NUMBER_NO_UNIT_PREFIX
)
from ledger.io import roles
...
class JournalEntryModelAbstract(CreateUpdateMixIn):
        ...
        if self.can_generate_je_number():
            ...
            with transaction.atomic():
                ...
                if self.entity_unit_id:
                    ...
                    unit_prefix = LEDGER_JE_NUMBER_NO_UNIT_PREFIX

                seq = str(state_model.sequence).zfill(LEDGER_DOCUMENT_NUMBER_PADDING)
                self.je_number = f'{LEDGER_JE_NUMBER_PREFIX}-{state_model.fiscal_year}-{unit_prefix}-{seq}'
    ...
    def get_absolute_url(self) -> str:
        ...
        """
        return reverse('ledger:je-detail', kwargs={
            'je_pk': self.uuid,
    ...
    def get_journal_entry_list_url(self) -> str:
        ...
        """
        return reverse('ledger:je-list', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id
        })
    ...
    def get_journal_entry_create_url(self) -> str:
        ...
        """
        return reverse('ledger:je-create', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id
        })
    ...
    def get_detail_txs_url(self) -> str:
        ...
        """
        return reverse('ledger:je-detail-txs', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id,
            'je_pk': self.uuid
        })
    ...
    def get_unlock_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-unlocked', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id,
            'je_pk': self.uuid
        })
    ...
    def get_lock_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-locked', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id,
            'je_pk': self.uuid
        })
    ...
    def get_post_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-posted', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id,
            'je_pk': self.uuid
        })
    ...
    def get_unpost_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-unposted', kwargs={
            'entity_slug': self.entity_slug,
            'ledger_pk': self.ledger_id,
            'je_pk': self.uuid
        })
    ...
    def get_action_post_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-posted',
                       kwargs={
                           'entity_slug': self.entity_slug,
                           'ledger_pk': self.ledger_id,
                           'je_pk': self.uuid
    ...
    def get_action_unpost_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-unposted',
                       kwargs={
                           'entity_slug': self.entity_slug,
                           'ledger_pk': self.ledger_id,
                           'je_pk': self.uuid
    ...
    def get_action_lock_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-locked',
                       kwargs={
                           'entity_slug': self.entity_slug,
                           'ledger_pk': self.ledger_id,
                           'je_pk': self.uuid
    ...
    def get_action_unlock_url(self) -> str:
        ...
        """
        return reverse('ledger:je-mark-as-unlocked',
                       kwargs={
                           'entity_slug': self.entity_slug,
                           'ledger_pk': self.ledger_id,
                           'je_pk': self.uuid
