"""
This module implements the different model MixIns used on different Ledger Models to implement common
functionality.
"""
import logging
...
from ledger.io import ASSET_CA_CASH, LIABILITY_CL_ST_NOTES_PAYABLE, LIABILITY_LTL_MORTGAGE_PAYABLE
from ledger.io.io_core import validate_io_timestamp, check_tx_balance, get_localtime, get_localdate
...
class ContactInfoMixIn(models.Model):
    ...
    """
    address_1 = models.CharField(null=True, blank=True, max_length=70, verbose_name=_('Address Line 1'))
...
class AccrualMixIn(models.Model):
    ...
    ledger = models.OneToOneField('ledger.LedgerModel',
                                  editable=False,
...
class FinancialAccountInfoMixin(models.Model):
    ...
    ACCOUNT_TYPE_CHOICES = [
        (LEDGER_CASH, _('Ledger Cash')),
        (BUDGETING_CASH, _('Budgeting Cash')),
