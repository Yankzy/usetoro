...
from ledger.models.bill import BillModel, BillModelQuerySet
from ledger.models.entity import EntityModel
from ledger.models.items import ItemTransactionModel, ItemTransactionModelQuerySet, ItemModelQuerySet, ItemModel
...
from ledger.settings import LEDGER_DOCUMENT_NUMBER_PADDING, LEDGER_PO_NUMBER_PREFIX
...
class PurchaseOrderModelAbstract(CreateUpdateMixIn,
    ...
    po_items = models.ManyToManyField('ledger.ItemModel',
    ...
    def get_mark_as_draft_url(self):
        ...
        str
            HTML ID as a String.
        """
        return reverse('ledger:po-action-mark-as-draft',
                       kwargs={
    ...
    def get_mark_as_review_url(self):
        ...
        str
            HTML ID as a String.
        """
        return reverse('ledger:po-action-mark-as-review',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'po_pk': self.uuid
                       })
    ...
    def get_mark_as_approved_url(self):
        ...
        str
            HTML ID as a String.
        """
        return reverse('ledger:po-action-mark-as-approved',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'po_pk': self.uuid
                       })
    ...
    def get_mark_as_canceled_url(self):
        ...
        str
            HTML ID as a String.
        """
        return reverse('ledger:po-action-mark-as-canceled',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'po_pk': self.uuid
                       })
    ...
    def get_mark_as_fulfilled_url(self):
        ...
        str
            URL as a String.
        """
        return reverse('ledger:po-action-mark-as-fulfilled',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'po_pk': self.uuid
                       })
    ...
    def get_mark_as_void_url(self):
        ...
        str
            HTML ID as a String.
        """
        return reverse('ledger:po-action-mark-as-void',
                       kwargs={
                           'entity_slug': self.entity.slug,
                           'po_pk': self.uuid
                       })
    ...
    def generate_po_number(self, commit: bool = False) -> str:
        ...
        if self.can_generate_po_number():
            with transaction.atomic(durable=True):
                ...
                self.po_number = f'{LEDGER_PO_NUMBER_PREFIX}-{state_model.fiscal_year}-{seq}'
