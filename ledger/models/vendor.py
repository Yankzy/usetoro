...
from ledger.models.mixins import ContactInfoMixIn, CreateUpdateMixIn, FinancialAccountInfoMixin, TaxInfoMixIn
from ledger.models.utils import lazy_loader
from ledger.settings import LEDGER_DOCUMENT_NUMBER_PADDING, LEDGER_VENDOR_NUMBER_PREFIX
...
class VendorModelManager(models.Manager):
    ...
    def for_entity(self, entity_slug, user_model) -> VendorModelQuerySet:
        ...
        if isinstance(entity_slug, lazy_loader.get_entity_model()):
            return cast(VendorModelQuerySet, qs.filter(
...
class VendorModelAbstract(ContactInfoMixIn,
    ...
    The VendorModel inherits functionality from the following MixIns:
        ...
        1. :func:`ContactInfoMixIn <ledger.models.mixins.ContactInfoMixIn>`
        2. :func:`BankAccountInfoMixIn <ledger.models.mixins.BankAccountInfoMixIn>`
        3. :func:`TaxInfoMixIn <ledger.models.mixins.TaxInfoMixIn>`
    ...
    def generate_vendor_number(self, commit: bool = False) -> Optional[str]:
        """
        ...
        if self.can_generate_vendor_number():
            ...
            self.vendor_number = f'{LEDGER_VENDOR_NUMBER_PREFIX}-{seq}'
