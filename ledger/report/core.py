...
from ledger.templatetags.ledger import currency_symbol, currency_format

if LEDGER_PDF_SUPPORT_ENABLED:
...
class BaseReportSupport(*load_support()):
    FOOTER_LOGO_PATH = 'ledger/logo/django-ledger-logo-report.png'
    ...
    def footer(self):
        ...
        self.image(self.get_report_footer_logo_path(),
                   w=30, x=(200 - 30) / 2,
                   link='https://www.fignode.com')
        self.ln(1)
        self.cell(0, 5,
                  'Powered by Ledger. Open Source software under GPLv3 License. ',
                  0, 1, 'C')
