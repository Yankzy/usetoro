...
from ledger.io import IODigestContextManager
from ledger.report.core import BaseReportSupport, PDFReportValidationError
from ledger.settings import LEDGER_CURRENCY_SYMBOL
...
class IncomeStatementReport(BaseReportSupport):
    ...
    def __init__(self, *args, io_digest: IODigestContextManager, report_subtitle: Optional[str] = None, **kwargs):
        ...
        self.TABLE_HEADERS = {
            ...
            'balance': {
                'title': f'Balance ({LEDGER_CURRENCY_SYMBOL})',
                'spacing': 10,
                'align': 'R'
            },
            'total': {
                'title': f'Total ({LEDGER_CURRENCY_SYMBOL})',
                'spacing': 10,
                'align': 'R',
                'style': 'B'
            }
