...
from ledger.urls.entity import urlpatterns as entity_urls
...
#         for entity_model in self.ENTITY_MODEL_QUERYSET:
    ...
    def test_ui_entity_create(self):
        ...
        # ENTITY-CREATE VIEW...
        entity_create_url = reverse('ledger:entity-create')
    ...
    def test_ui_entity_list(self):
        ...
        entity_list_url = reverse('ledger:entity-list')
        ...
        with self.assertNumQueries(3):
            ...
            for entity_model in entity_qs:
                ...
                self.assertContains(response,
                                    status_code=200,
                                    text=reverse('ledger:entity-delete',
                                                 kwargs={
    ...
    def test_ui_entity_update(self):
        ...
        # ENTITY-UPDATE VIEW...
        with self.assertNumQueries(3):
            entity_update_url = reverse('ledger:entity-update',
                                        kwargs={
    ...
    def test_ui_entity_detail(self):
        ...
        with self.assertNumQueries(2):
            ...
            entity_detail_url = reverse('ledger:entity-dashboard',
                                        kwargs={
                                            'entity_slug': entity_model.slug
                                        })
        ...
        with self.assertNumQueries(8):  # previously 10
            ...
            entity_month_detail_url = reverse('ledger:entity-dashboard-month',
                                              kwargs={
                                                  'entity_slug': entity_model.slug,
                                                  'year': local_dt.year,
    ...
    def test_ui_delete_entity(self):
        ...
        with self.assertNumQueries(4):
            entity_delete_url = reverse('ledger:entity-delete',
                                        kwargs={
                                            'entity_slug': entity_model.slug
                                        })
