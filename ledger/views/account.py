...
from ledger.forms.account import AccountModelUpdateForm, AccountModelCreateForm
from ledger.io.io_core import get_localdate
from ledger.models import EntityModel, ChartOfAccountModel
...
class AccountModelListView(BaseAccountModelBaseView, ListView):
    template_name = 'ledger/account/account_list.html'
...
class AccountModelCreateView(BaseAccountModelBaseView, CreateView):
    template_name = 'ledger/account/account_create.html'
...
class AccountModelUpdateView(BaseAccountModelBaseView, UpdateView):
    ...
    template_name = 'ledger/account/account_update.html'
...
class AccountModelDetailView(BaseAccountModelBaseView, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        entity_model: EntityModel = self.get_authorized_entity_instance()
        return reverse('ledger:account-detail-month',
                       kwargs={
...
class AccountModelYearDetailView(BaseAccountModelBaseView,
                                 ...
                                 DetailView):
    context_object_name = 'account'
    template_name = 'ledger/account/account_detail.html'
    slug_url_kwarg = 'account_pk'
    slug_field = 'uuid'
    DEFAULT_TXS_DAYS = 30
    extra_context = {
