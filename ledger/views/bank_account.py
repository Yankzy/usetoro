...
from ledger.forms.bank_account import BankAccountCreateForm, BankAccountUpdateForm
...
class BankAccountModelListView(BankAccountModelModelBaseView, ListView):
    template_name = 'ledger/bank_account/bank_account_list.html'
...
class BankAccountModelCreateView(BankAccountModelModelBaseView, CreateView):
    template_name = 'ledger/bank_account/bank_account_create.html'
...
class BankAccountModelUpdateView(BankAccountModelModelBaseView, UpdateView):
    template_name = 'ledger/bank_account/bank_account_update.html'
