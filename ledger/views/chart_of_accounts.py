...
from ledger.forms.chart_of_accounts import ChartOfAccountsModelUpdateForm, ChartOfAccountsModelCreateForm
...
class ChartOfAccountModelListView(ChartOfAccountModelModelBaseViewMixIn, ListView):
    template_name = 'ledger/chart_of_accounts/coa_list.html'
...
class ChartOfAccountModelCreateView(ChartOfAccountModelModelBaseViewMixIn, CreateView):
    template_name = 'ledger/chart_of_accounts/coa_create.html'
    extra_context = {
...
class ChartOfAccountModelUpdateView(ChartOfAccountModelModelBaseViewMixIn, UpdateView):
    ...
    template_name = 'ledger/chart_of_accounts/coa_update.html'
