...
from ledger.forms.closing_entry import ClosingEntryCreateForm, ClosingEntryUpdateForm
...
from ledger.views import DjangoLedgerSecurityMixIn
...
class ClosingEntryModelListView(ClosingEntryModelBaseView, ArchiveIndexView):
    template_name = 'ledger/closing_entry/closing_entry_list.html'
...
class ClosingEntryModelCreateView(ClosingEntryModelBaseView, CreateView):
    template_name = 'ledger/closing_entry/closing_entry_create.html'
    ...
    def get_success_url(self):
        return reverse(
            viewname='ledger:closing-entry-detail',
            kwargs={
...
class ClosingEntryModelDetailView(ClosingEntryModelBaseView, DetailView):
    template_name = 'ledger/closing_entry/closing_entry_detail.html'
...
class ClosingEntryModelUpdateView(ClosingEntryModelBaseView, UpdateView):
    template_name = 'ledger/closing_entry/closing_entry_update.html'
    pk_url_kwarg = 'closing_entry_pk'
...
class ClosingEntryDeleteView(ClosingEntryModelBaseView, DeleteView):
    template_name = 'ledger/closing_entry/closing_entry_delete.html'
    pk_url_kwarg = 'closing_entry_pk'
    ...
    def get_success_url(self):
        return reverse(viewname='ledger:closing-entry-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ClosingEntryModelActionView(ClosingEntryModelBaseView,
    ...
    def get_redirect_url(self, *args, **kwargs):
        return reverse('ledger:closing-entry-detail',
                       kwargs={
