...
from ledger.forms.customer import CustomerModelForm
...
class CustomerModelListView(DjangoLedgerSecurityMixIn,
                            ...
                            ListView):
    template_name = 'ledger/customer/customer_list.html'
...
class CustomerModelCreateView(DjangoLedgerSecurityMixIn,
                              CustomerModelModelViewQuerySetMixIn,
                              CreateView):
    template_name = 'ledger/customer/customer_create.html'
...
class CustomerModelUpdateView(DjangoLedgerSecurityMixIn,
                              CustomerModelModelViewQuerySetMixIn,
                              UpdateView):
    template_name = 'ledger/customer/customer_update.html'
