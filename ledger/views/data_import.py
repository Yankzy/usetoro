...
from ledger.forms.data_import import ImportJobModelCreateForm, ImportJobModelUpdateForm
from ledger.forms.data_import import StagedTransactionModelFormSet
from ledger.io.ofx import OFXFileManager
...
class ImportJobModelCreateView(ImportJobModelViewBaseView, FormView):
    template_name = 'ledger/data_import/import_job_create.html'
...
class ImportJobModelListView(ImportJobModelViewBaseView, ListView):
    ...
    template_name = 'ledger/data_import/data_import_job_list.html'


class ImportJobModelUpdateView(ImportJobModelViewBaseView, UpdateView):
    template_name = 'ledger/data_import/import_job_update.html'
    ...
    def get_success_url(self):
        entity_model = self.get_authorized_entity_instance()
        return reverse(
            viewname='ledger:data-import-jobs-list',
            kwargs={
...
class ImportJobModelDeleteView(ImportJobModelViewBaseView, DeleteView):
    template_name = 'ledger/data_import/import_job_delete.html'
    context_object_name = 'import_job_model'
    pk_url_kwarg = 'job_pk'
...
class DataImportJobDetailView(ImportJobModelViewBaseView, DetailView):
    template_name = 'ledger/data_import/data_import_job_txs.html'
