...
from ledger.forms.feedback import BugReportForm, RequestNewFeatureForm
from ledger.settings import LEDGER_FEEDBACK_EMAIL_LIST, LEDGER_FEEDBACK_FROM_EMAIL
from ledger.views.mixins import DjangoLedgerSecurityMixIn, SuccessUrlNextMixIn
...
class BugReportView(DjangoLedgerSecurityMixIn,
    ...
    def form_valid(self, form):
        ...
        if LEDGER_FEEDBACK_EMAIL_LIST:
            send_mail(
                subject=f'DJL Bug Report',
                from_email=LEDGER_FEEDBACK_FROM_EMAIL,
                recipient_list=LEDGER_FEEDBACK_EMAIL_LIST,
                fail_silently=True,
                message=message)
