...
from ledger.forms.invoice import (BaseInvoiceModelUpdateForm, InvoiceModelCreateForEstimateForm,
...
from ledger.models import EntityModel, LedgerModel, EstimateModel
...
class InvoiceModelListView(DjangoLedgerSecurityMixIn, InvoiceModelModelViewQuerySetMixIn, ArchiveIndexView):
    template_name = 'ledger/invoice/invoice_list.html'
...
class InvoiceModelCreateView(DjangoLedgerSecurityMixIn, InvoiceModelModelViewQuerySetMixIn, CreateView):
    template_name = 'ledger/invoice/invoice_create.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.for_estimate:
            context['form_action_url'] = reverse('ledger:invoice-create-estimate',
                                                 kwargs={
                                                     'entity_slug': self.kwargs['entity_slug'],
            ...
            context['form_action_url'] = reverse('ledger:invoice-create',
                                                 kwargs={
                                                     'entity_slug': self.kwargs['entity_slug']
                                                 })
        return context
...
class InvoiceModelUpdateView(DjangoLedgerSecurityMixIn, InvoiceModelModelViewQuerySetMixIn, UpdateView):
    ...
    template_name = 'ledger/invoice/invoice_update.html'
    ...
    def get_success_url(self):
        ...
        return reverse('ledger:invoice-update',
                       kwargs={
                           'entity_slug': entity_slug,
    ...
    def get(self, request, entity_slug, invoice_pk, *args, **kwargs):
        if self.action_update_items:
            return HttpResponseRedirect(
                redirect_to=reverse('ledger:invoice-update',
                                    kwargs={
                                        'entity_slug': entity_slug,
                                        'invoice_pk': invoice_pk
                                    })
...
class InvoiceModelDetailView(DjangoLedgerSecurityMixIn, InvoiceModelModelViewQuerySetMixIn, DetailView):
    ...
    slug_field = 'uuid'
    context_object_name = 'invoice'
    template_name = 'ledger/invoice/invoice_detail.html'
    extra_context = {
        'hide_menu': True
    }
...
class InvoiceModelDeleteView(DjangoLedgerSecurityMixIn, InvoiceModelModelViewQuerySetMixIn, DeleteView):
    slug_url_kwarg = 'invoice_pk'
    slug_field = 'uuid'
    template_name = 'ledger/invoice/invoice_delete.html'
    context_object_name = 'invoice'
    extra_context = {
        'hide_menu': True
    }
