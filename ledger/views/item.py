...
from ledger.models import ItemModel, UnitOfMeasureModel, EntityModel
...
class UnitOfMeasureModelListView(UnitOfMeasureModelModelBaseView, ListView):
    template_name = 'ledger/uom/uom_list.html'
...
class UnitOfMeasureModelCreateView(UnitOfMeasureModelModelBaseView, CreateView):
    template_name = 'ledger/uom/uom_create.html'
    ...
    def get_success_url(self):
        return reverse('ledger:uom-list',
                       kwargs={
...
class UnitOfMeasureModelUpdateView(UnitOfMeasureModelModelBaseView, UpdateView):
    template_name = 'ledger/uom/uom_update.html'
...
class UnitOfMeasureModelDeleteView(UnitOfMeasureModelModelBaseView, DeleteView):
    pk_url_kwarg = 'uom_pk'
    template_name = 'ledger/uom/uom_delete.html'
    ...
    def form_valid(self, form):
        try:
            ...
            return HttpResponseRedirect(
                redirect_to=reverse('ledger:uom-list',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug']
                                    })
            )
...
class ProductListView(ProductItemModelModelBaseView, ListView):
    template_name = 'ledger/product/product_list.html'
...
class ProductCreateView(ProductItemModelModelBaseView, CreateView):
    template_name = 'ledger/product/product_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('ledger:product-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ProductUpdateView(ProductItemModelModelBaseView, UpdateView):
    template_name = 'ledger/product/product_update.html'
...
class ProductDeleteView(ProductItemModelModelBaseView, DeleteView):
    template_name = 'ledger/product/product_delete.html'
    pk_url_kwarg = 'item_pk'
    ...
    def form_valid(self, form):
        try:
            ...
            return HttpResponseRedirect(
                redirect_to=reverse('ledger:product-list',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug']
                                    })
            )
...
class ServiceListView(ServiceItemModelModelBaseView, ListView):
    template_name = 'ledger/service/service_list.html'
...
class ServiceCreateView(ServiceItemModelModelBaseView, CreateView):
    template_name = 'ledger/service/service_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('ledger:service-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ServiceUpdateView(ServiceItemModelModelBaseView, UpdateView):
    template_name = 'ledger/service/service_update.html'
...
class ServiceDeleteView(ServiceItemModelModelBaseView, DeleteView):
    template_name = 'ledger/service/service_delete.html'
    pk_url_kwarg = 'item_pk'
    context_object_name = 'item_model'
    ...
    def form_valid(self, form):
        try:
            ...
            return HttpResponseRedirect(
                redirect_to=reverse('ledger:service-list',
                                    kwargs={
                                        'entity_slug': self.kwargs['entity_slug']
                                    })
            )
...
class ExpenseItemModelListView(ExpenseItemItemModelModelBaseView, ListView):
    template_name = 'ledger/expense/expense_list.html'
...
class ExpenseItemCreateView(ExpenseItemItemModelModelBaseView, CreateView):
    template_name = 'ledger/expense/expense_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('ledger:expense-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class ExpenseItemUpdateView(ExpenseItemItemModelModelBaseView, UpdateView):
    template_name = 'ledger/expense/expense_update.html'
...
class InventoryItemModelListView(InventoryItemItemModelModelBaseView, ListView):
    template_name = 'ledger/inventory/inventory_item_list.html'
...
class InventoryItemCreateView(InventoryItemItemModelModelBaseView, CreateView):
    template_name = 'ledger/inventory/inventory_item_create.html'
    model = ItemModel
    ...
    def get_success_url(self):
        return reverse('ledger:inventory-item-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class InventoryItemUpdateView(InventoryItemItemModelModelBaseView, UpdateView):
    template_name = 'ledger/inventory/inventory_item_update.html'
