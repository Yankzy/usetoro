...
from ledger.models import EntityModel, InvoiceModel, BillModel
from ledger.models.entity import EntityModelFiscalPeriodMixIn
from ledger.settings import LEDGER_PDF_SUPPORT_ENABLED, LEDGER_AUTHORIZED_SUPERUSER
...
class DjangoLedgerSecurityMixIn(LoginRequiredMixin, PermissionRequiredMixin):
    ...
    AUTHORIZE_SUPERUSER: bool = LEDGER_AUTHORIZED_SUPERUSER
    permission_required = []
