...
from ledger.forms.purchase_order import (PurchaseOrderModelCreateForm, BasePurchaseOrderModelUpdateForm,
...
from ledger.models import PurchaseOrderModel, ItemTransactionModel, EstimateModel
...
class PurchaseOrderModelListView(DjangoLedgerSecurityMixIn,
                                 ...
                                 ArchiveIndexView):
    template_name = 'ledger/purchase_order/po_list.html'
...
class PurchaseOrderModelCreateView(DjangoLedgerSecurityMixIn,
                                   PurchaseOrderModelModelViewQuerySetMixIn,
                                   CreateView):
    template_name = 'ledger/purchase_order/po_create.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.for_estimate:
            context['form_action_url'] = reverse('ledger:po-create-estimate',
                                                 kwargs={
                                                     'entity_slug': self.kwargs['entity_slug'],
            ...
            context['form_action_url'] = reverse('ledger:po-create',
                                                 kwargs={
                                                     'entity_slug': self.kwargs['entity_slug']
                                                 })
        return context
    ...
    def get_success_url(self):
        ...
        if self.for_estimate:
            ce_pk = self.kwargs['ce_pk']
            return reverse('ledger:customer-estimate-detail',
                           kwargs={
                               'entity_slug': self.kwargs['entity_slug'],
                               'ce_pk': ce_pk
                           })
        return reverse('ledger:po-list',
                       kwargs={
                           'entity_slug': entity_slug
                       })
...
class PurchaseOrderModelUpdateView(DjangoLedgerSecurityMixIn,
    ...
    template_name = 'ledger/purchase_order/po_update.html'
    extra_context = {
        'header_subtitle_icon': 'uil:bill'
    }
    ...
    def get(self, request, entity_slug, po_pk, *args, **kwargs):
        if self.action_update_items:
            return HttpResponseRedirect(
                redirect_to=reverse('ledger:po-update',
                                    kwargs={
                                        'entity_slug': entity_slug,
                                        'po_pk': po_pk
                                    })
    ...
    def get_success_url(self):
        ...
        return reverse('ledger:po-detail',
                       kwargs={
                           'entity_slug': entity_slug,
                           'po_pk': po_pk
                       })
...
class PurchaseOrderModelDetailView(DjangoLedgerSecurityMixIn,
    ...
    slug_field = 'uuid'
    context_object_name = 'po_model'
    template_name = 'ledger/purchase_order/po_detail.html'
    extra_context = {
        'header_subtitle_icon': 'uil:bill',
        'hide_menu': True
    }
...
class PurchaseOrderModelDeleteView(DjangoLedgerSecurityMixIn,
    ...
    slug_field = 'uuid'
    context_object_name = 'po_model'
    template_name = 'ledger/purchase_order/po_delete.html'
    extra_context = {
        'hide_menu': True,
        'header_subtitle_icon': 'uil:bill'
    }
...
class BasePurchaseOrderActionActionView(DjangoLedgerSecurityMixIn,
    ...
    def get_redirect_url(self, entity_slug, po_pk, *args, **kwargs):
        return reverse('ledger:po-update',
                       kwargs={
                           'entity_slug': entity_slug,
                           'po_pk': po_pk
                       })
