...
from ledger.forms.unit import EntityUnitModelCreateForm, EntityUnitModelUpdateForm
from ledger.io.io_core import get_localdate
from ledger.models import EntityUnitModel, EntityModel
from ledger.views.financial_statement import FiscalYearIncomeStatementView
from ledger.views.mixins import (DjangoLedgerSecurityMixIn, QuarterlyReportMixIn, MonthlyReportMixIn,
...
class EntityUnitModelListView(EntityUnitModelModelBaseView, ListView):
    template_name = 'ledger/unit/unit_list.html'
...
class EntityUnitModelDetailView(EntityUnitModelModelBaseView, DetailView):
    template_name = 'ledger/unit/unit_detail.html'
...
class EntityUnitModelCreateView(EntityUnitModelModelBaseView, CreateView):
    template_name = 'ledger/unit/unit_create.html'
    ...
    def get_success_url(self):
        return reverse('ledger:unit-list',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug']
                       })
...
class EntityUnitUpdateView(EntityUnitModelModelBaseView, UpdateView):
    template_name = 'ledger/unit/unit_update.html'
...
class BaseEntityUnitModelBalanceSheetView(EntityUnitModelModelBaseView, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        ...
        return reverse('ledger:unit-bs-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
...
class FiscalYearEntityUnitModelBalanceSheetView(EntityUnitModelModelBaseView,
    ...
    slug_url_kwarg = 'unit_slug'
    template_name = 'ledger/financial_statements/balance_sheet.html'
    pdf_report_type = 'BS'
...
class BaseEntityUnitModelIncomeStatementView(EntityUnitModelModelBaseView, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        year = get_localdate().year
        return reverse('ledger:unit-ic-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'unit_slug': self.kwargs['unit_slug'],
                           'year': year
...
class FiscalYearEntityUnitModelIncomeStatementView(EntityUnitModelModelBaseView,
    ...
    context_object_name = 'unit_model'
    slug_url_kwarg = 'unit_slug'
    template_name = 'ledger/financial_statements/income_statement.html'
    pdf_report_type = 'IS'
...
class BaseEntityUnitModelCashFlowStatementView(EntityUnitModelModelBaseView, RedirectView):
    ...
    def get_redirect_url(self, *args, **kwargs):
        year = get_localdate().year
        return reverse('ledger:unit-cf-year',
                       kwargs={
                           'entity_slug': self.kwargs['entity_slug'],
                           'unit_slug': self.kwargs['unit_slug'],
                           'year': year
...
class FiscalYearEntityUnitModelCashFlowStatementView(EntityUnitModelModelBaseView,
    ...
    context_object_name = 'unit_model'
    slug_url_kwarg = 'unit_slug'
    template_name = 'ledger/financial_statements/cash_flow.html'
    pdf_report_type = 'CFS'
