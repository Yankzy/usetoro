...
from bookkeeping_state_eval.domain.enums import Eligibility
...
from bookkeeping_state_eval.routing.service import RoutingPlan, RoutingService
...
from bookkeeping_state_eval.state.bookkeeping_state import BookkeepingStateClosedError
...
def test_final_validation_failure():
    ...
    with patch(
        "bookkeeping_state_eval.session.bookkeeping_session.validate_state",
