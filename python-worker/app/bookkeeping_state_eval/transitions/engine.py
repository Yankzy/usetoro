...
from bookkeeping_state_eval.domain.events import (
    StateEvent,
    StateEventType,
)
...
from bookkeeping_state_eval.transitions.handlers.classification import (
    handle_classification_command,
)
from bookkeeping_state_eval.transitions.handlers.evidence import (
    handle_evidence_command,
)
from bookkeeping_state_eval.transitions.handlers.reconciliation import (
    handle_reconciliation_command,
)
from bookkeeping_state_eval.transitions.handlers.routing import (
...
class TransitionEngine:
    ...
    def _check_cross_sibling_conflicts(
        *,
        ...
        from bookkeeping_state_eval.state.derived import build_derived_state
