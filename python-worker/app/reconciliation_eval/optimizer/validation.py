...
from domain.base import Direction
...
def validate_optimizer_request(req: OptimizerRequest) -> OptimizerResponse:
    """
    Performs deterministic pre-solve validation (Section 27).
    Returns an INVALID_INPUT response if any constraint fails, 
    otherwise returns a success status indicating it's ready for the solver.
    """
    diagnostics = []
