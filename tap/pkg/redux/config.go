...
type EngineConfig struct {
	...
	Metrics         MetricsRecorder // Binds native Prometheus or OpenTelemetry collection objects
	RBAC            RBACPolicy      // Injected Actor-authorization boundaries guaranteeing operational paths
}

// DefaultConfig provides optimal safe bounds scaling up out-of-the-box
